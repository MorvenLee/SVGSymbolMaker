...
buttons[4]=new	Array( "距离量算", "面积量算", "缓冲区分析", "空间查找", "方位查找", "叠置分析", "点统计", "矩形统计", "多图层网络分析", "综合分析");
...
//---nancy add 20130403---连接到原系统---
makeLink(document.getElementById('MenuL2G-0-0-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-0-1-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-0-2-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-0-3-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-0-4-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-0-5-0'), "/SircNancy/");
//
makeLink(document.getElementById('MenuL2G-2-0-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-2-1-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-2-2-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-2-3-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
//
makeLink(document.getElementById('MenuL2G-5-0-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-5-1-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-5-2-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-5-3-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
makeLink(document.getElementById('MenuL2G-5-4-0'), "http://192.168.1.155:8080/SVGGIS/ssesql.jsp");
//
makeLink(document.getElementById('MenuL2G-7-0-0'), "http://192.168.1.155:8080/SVGGIS/tools/watermark/watermark.htm");
makeLink(document.getElementById('MenuL2G-7-1-0'), "http://192.168.1.155:8080/SVGGIS/tools/antimation/index.jsp");
//---nancy add 20130403---	
/*
...
function menuonclick(i,j,k){//whw
	...
	else if(menuno=="menu42"){
		window.parent.clicktool(23,'缓冲区');
		window.parent.SwitchBtn(23,'Down');
	}
	else if(menuno=="menu43"){
		window.parent.clicktool(32,'空间查找');
		window.parent.SwitchBtn(32,'Down');
	}
	else if(menuno=="menu44"){
		window.parent.clicktool(41,'方位查找');
		window.parent.SwitchBtn(41,'Down');
	}
	else if(menuno=="menu45"){//叠置分析
		//window.open('/SircNancy/analysis/overlap.jsp');
		//新链接		
	}
	else if(menuno=="menu46"){
		window.parent.clicktool(24,'点统计');
		window.parent.SwitchBtn(24,'Down');
	}
	else if(menuno=="menu47"){
		window.parent.clicktool(17,'矩形统计');
		window.parent.SwitchBtn(17,'Down');
	}
	else if(menuno=="menu48"){
		window.parent.clicktool(29,'网络分析');
		window.parent.SwitchBtn(29,'Down');
	}
	else if(menuno=="menu49"){//综合分析
		//新链接
	}	
	else if(menuno=="menu60"){//地理定位
		window.parent.clicktool(25,'地理定位');
		window.parent.SwitchBtn(25,'Down');
	}	
	else if(menuno=="menu61"){//定位查询
		window.parent.clicktool(31,'定位查询');
		window.parent.SwitchBtn(31,'Down');
	}	
	else if(menuno=="menu30"){//点选查询
		window.parent.clicktool(13,'点选查询');
		window.parent.SwitchBtn(13,'Down');
	}
	else if(menuno=="menu31"){//拉框查询
		window.parent.clicktool(14,'拉框查询');
		window.parent.SwitchBtn(14,'Down');
	}
	else if(menuno=="menu32"){//圆选查询
		window.parent.clicktool(22,'圆选查询');
		window.parent.SwitchBtn(22,'Down');
	}	
	else if(menuno=="menu33"){//数图查询
		window.parent.clicktool(33,'数图查询');
		window.parent.SwitchBtn(33,'Down');
	}			
}
