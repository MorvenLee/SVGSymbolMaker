...
button.prototype.testParent = function() {
    ...
    if (typeof(this.parentNode) == "object") {
    	...
    	if (!document.getElementById(this.parentNode)) {
        	...
        	//nancy edit
        	this.parentGroup.setAttributeNS(null,"id",this.id);
...
//make link add nancy 20130423
//show:self,new,Share_Main(embed name)
//target:_blank,_top
button.prototype.makeLinkButton = function(url,show,target) {

	var element = this.parentGroup;
   ...
   Llink.setAttributeNS(xlinkNS, 'xlink:show',show); 
